...
La letra la pones tú. Las letras de canciones tienen derechos de autor y esta app
no las descarga de ningún lado. Si quieres automatizarlo, necesitas una API con
licencia (Musixmatch), y su plan gratuito solo devuelve un fragmento y exige
mostrar la atribución.
